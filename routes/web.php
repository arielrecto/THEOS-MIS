...
Route::middleware([
    ...
    Route::middleware(['role:admin'])->prefix('admin')->as('admin.')->group(function () {
        ...
        Route::prefix('general-announcements')->as('general-announcements.')->group(function () {
    ...
    Route::middleware(['role:registrar'])->prefix('registrar')->as('registrar.')->group(function () {

    ...
    <div class="container mx-auto p-4 sm:p-6 lg:p-8 max-w-4xl">
        ...
        <div class="mb-6">
            <div class="flex items-center gap-3 mb-2">
                ...
                <h1 class="text-2xl sm:text-3xl font-bold text-gray-800">Edit Header Content</h1>
            </div>
            <p class="text-sm text-gray-600 ml-12">Update header content information</p>
        </div>

        <div class="bg-white rounded-lg shadow-sm p-4 sm:p-6">
            <form action="{{ route('admin.CMS.header-contents.update', $headerContent) }}" method="POST"
                class="space-y-6">
                @csrf
                @method('PUT')
                ...
                <div class="form-control w-full">
                    ...
                    <input type="text" name="title" value="{{ old('title', $headerContent->title) }}"
                ...
                <div class="form-control w-full">
                    ...
                    <textarea name="subtitle" rows="3"
                        ...
                        placeholder="Enter subtitle or description">{{ old('subtitle', $headerContent->subtitle) }}</textarea>
                    @error('subtitle')
                        <label class="label">
                            <span class="label-text-alt text-error">{{ $message }}</span>
                        </label>
                ...
                <div class="form-control">
                    <label class="label cursor-pointer justify-start gap-3">
                        <input type="checkbox" name="show_button" value="1" class="checkbox checkbox-primary"
                            {{ old('show_button', $headerContent->show_button) ? 'checked' : '' }} x-data
                ...
                <div x-data x-ref="buttonFields"
                    class="{{ old('show_button', $headerContent->show_button) ? '' : 'hidden' }} space-y-4 pl-4 border-l-2 border-primary/20">
                    <!-- Button Text -->
                    <div class="form-control w-full">
                        <label class="label">
                        ...
                        <input type="text" name="button_text"
                            value="{{ old('button_text', $headerContent->button_text) }}"
                    ...
                    <div class="form-control w-full">
                        ...
                        <input type="url" name="button_url"
                            value="{{ old('button_url', $headerContent->button_url) }}"
                ...
                <div class="form-control">
                    <label class="label cursor-pointer justify-start gap-3">
                        <input type="checkbox" name="is_active" value="1" class="checkbox checkbox-success"
                            {{ old('is_active', $headerContent->is_active) ? 'checked' : '' }}>
                        <div>

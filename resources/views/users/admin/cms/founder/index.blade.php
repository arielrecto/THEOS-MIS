{{-- filepath: e:\Projects\Theos MIS\resources\views\users\admin\cms\founder\index.blade.php --}}
<x-dashboard.admin.base>
    <div class="w-full px-4 sm:px-6 py-4 sm:py-6">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-5">
            <div class="min-w-0">
                <h1 class="text-xl sm:text-2xl font-bold text-gray-800 break-words">Founders</h1>
                <p class="text-sm text-gray-600">Manage founders and profile details</p>
            </div>
            ...
            <div class="flex flex-col sm:flex-row gap-2 w-full sm:w-auto">
                ...
                <a href="{{ route('admin.CMS.founders.create') }}"
                   class="btn btn-accent btn-sm sm:btn-md w-full sm:w-auto justify-center gap-2">
                    <i class="fi fi-rr-plus"></i>
                    <span class="text-xs sm:text-sm">Add Founder</span>
                </a>
            </div>
        </div>
                    ...
                    @forelse($founders as $founder)
                        <article class="border rounded-lg p-4">
                            ...
                            <div class="mt-3 flex gap-2">
                                <a href="{{ route('admin.CMS.founders.show', $founder) }}" class="btn btn-ghost btn-sm flex-1 justify-center gap-2">
                                    <i class="fi fi-rr-eye"></i><span class="text-xs">View</span>
                                </a>
                                <a href="{{ route('admin.CMS.founders.edit', $founder) }}" class="btn btn-accent btn-sm flex-1 justify-center gap-2">
                                    <i class="fi fi-rr-edit"></i><span class="text-xs">Edit</span>
                                </a>
                            </div>
                        </article>
                    @empty
                        <div class="py-10 text-center text-gray-500">No founders found.</div>
                    @endforelse
                </div>
                                ...
                                <tr>
                                    <td>
                                        <div class="flex items-center gap-3">
                                            ...
                                            <div class="font-medium text-gray-800">{{ $founder->name }}</div>
                                        </div>
                                    </td>
                                    <td>
                                    ...
                                    <td class="text-right">
                                        <a href="{{ route('admin.CMS.founders.show', $founder) }}" class="btn btn-ghost btn-sm">View</a>
                                        <a href="{{ route('admin.CMS.founders.edit', $founder) }}" class="btn btn-accent btn-sm">Edit</a>
                                    </td>
                                </tr>
                            @empty
                                <tr>
                                    <td colspan="4" class="py-10 text-center text-gray-500">No founders found.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>

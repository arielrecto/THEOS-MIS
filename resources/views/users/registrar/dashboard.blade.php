<x-dashboard.registrar.base>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-6">
        ...
        <div class="p-6 rounded-lg shadow-lg bg-base-100">
            <h2 class="mb-4 text-xl sm:text-2xl font-bold text-blue-500">Enrollment Statistics</h2>
        ...
        <!-- Recent Enrollments -->
        <div class="p-6 rounded-lg shadow-lg bg-base-100">
            <h2 class="mb-4 text-xl sm:text-2xl font-bold text-blue-500">Recent Enrollments</h2>

            <div class="space-y-4">
                @forelse($recentEnrollments as $enrollment)
                    <div
                        class="flex flex-col sm:flex-row sm:items-center sm:justify-between p-3 bg-base-200 rounded-lg">
                        <div class="min-w-0">

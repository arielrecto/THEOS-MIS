    ...
    <div class="form-137">
        ...
        <div class="grid grid-cols-2 gap-4 mb-6">
            <div>
                ...
                <p><strong>Date of Birth:</strong> {{ $student->studentProfile?->birthdate ?? 'N\A' }}</p>
            </div>
            <div>
        ...
        <!-- Academic Records -->
        @if (!$student->studentProfile?->academicRecords)
            <p class="text-center text-gray-500">No academic records found.</p>
        @else

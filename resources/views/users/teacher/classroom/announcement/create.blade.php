<x-dashboard.teacher.base>
    ...
    <x-dashboard.page-title :title="_('Create Announcement')" :back_url="request()->type === 'classroom' ? route('teacher.classrooms.show', ['classroom' => $classroom_id]) : route('teacher.announcements.index')" />
            ...
            <form action="{{ route('teacher.announcements.store') }}" method="post" enctype="multipart/form-data"
                ...
                <div class="form-control" x-data="{ fileName: '' }">
                    ...
                    <div class="border-2 border-dashed border-base-300 rounded-lg p-6">
                        ...
                        <label for="attachment" class="flex flex-col items-center justify-center cursor-pointer">
                ...
                <div class="flex justify-end gap-2">
                    ...
                    @else
                        <a href="{{ route('teacher.announcements.index') }}" class="btn btn-ghost">
                            Cancel
                        </a>
                    @endif

<x-dashboard.student.base>
    <div class="container p-6 mx-auto">
        ...
        <div class="grid gap-6">
                ...
                <form method="POST" action="{{ route('student.settings.profile.update') }}" class="space-y-6">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="contact_number" value="{{ old('contact_number', $student->studentProfile->contact_number) }}"
                        ...
                        <div>
                            ...
                            <input type="text" name="parent_name" value="{{ old('parent_name', $student->studentProfile->parent_name) }}"
                                   class="mt-1 input input-bordered w-full" required>
                            @error('parent_name')
                                <p class="mt-1 text-sm text-error">{{ $message }}</p>
                            @enderror
                        ...
                        <div>
                            ...
                            <input type="text" name="relationship" value="{{ old('relationship', $student->studentProfile->relationship) }}"
                                   class="mt-1 input input-bordered w-full" required>
                            @error('relationship')
                                <p class="mt-1 text-sm text-error">{{ $message }}</p>
                            @enderror
                        ...
                        <div class="col-span-2">
                            ...
                            <textarea name="address" class="mt-1 textarea textarea-bordered w-full" rows="3" required>{{ old('address', $student->studentProfile->address) }}</textarea>
                            @error('address')
                                <p class="mt-1 text-sm text-error">{{ $message }}</p>
                            @enderror
                        </div>
            ...
            <!-- Update Email -->
            <div class="p-6 bg-white rounded-lg shadow-md">
                <h2 class="text-lg font-medium text-gray-900 mb-4">Update Email</h2>
            ...
            <div class="p-6 bg-white rounded-lg shadow-md">
                ...
                <form method="POST" action="{{ route('student.settings.password.update') }}" class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="password" name="current_password" class="mt-1 input input-bordered w-full" required>
                    ...
                    <div>
                        ...
                        <input type="password" name="password" class="mt-1 input input-bordered w-full" required>
                        @error('password')
                            <p class="mt-1 text-sm text-error">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        ...
                        <input type="password" name="password_confirmation" class="mt-1 input input-bordered w-full" required>
                    </div>
